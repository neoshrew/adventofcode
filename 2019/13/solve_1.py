...
class IntCode(BaseIntCode):
    ...
    def game_init(self):
        ...
        for x, y, cell_id in self._game_init_output_chunker():
            self.grid[(x, y)] = cell_id

        self.initialised = True

    def _game_init_output_chunker(self):
    ...
    def input(self):
        raise Exception("Not expecting to produce input")
...
print(sum(1 if i == 2 else 0 for i in inst.grid.values()))
